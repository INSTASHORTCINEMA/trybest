...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'ARMANOPKING')
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/INSTASHORTCINEMA')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/gxgxxgguf')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'instashortcinema')
...
URL = "https://trybest-bde37a4b6a51.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://trybest-bde37a4b6a51.herokuapp.com/".format(FQDN, PORT)
SLEEP_THRESHOLD = int(environ.get('SLEEP_THRESHOLD', '60'))
WORKERS = int(environ.get('WORKERS', '4'))
SESSION_NAME = str(environ.get('SESSION_NAME', 'trybest'))
MULTI_CLIENT = False
name = str(environ.get('name', 'trybest'))
...
if HAS_SSL:
    URL = "https://trybest-bde37a4b6a51.herokuapp.com/".format(FQDN)
else:
    URL = "https://trybest-bde37a4b6a51.herokuapp.com/".format(FQDN)
